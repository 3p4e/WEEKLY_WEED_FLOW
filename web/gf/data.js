...
GF.I18N = {
  en: {
    ...
    calendar_sub:'Tasks by due date across the month', workload_sub:'Per-person load for the week — drag a task to assign it',
    ...
    rec_every:'Every N', rec_until:'Until (optional)',
    log_work:'Log work', add_subtask:'Add subtask', archive:'Archive', outcome:'Outcome', open_detail:'Open',
    unarchive:'Unarchive', archived:'Archived', show_archived:'Show archived',
    mark_done:'Mark done', change_status:'Change status',
    inbox:'Inbox', inbox_sub:'Notifications, team activity and the digest',
    ...
    cultivation:'Cultivation', cultivation_sub:'Cultivars, coded batches and individually numbered plants',
    harvest:'Harvest', harvest_sub:'Harvest lots, dry yield and the plant-protection intervals that gate a cut',
    irrigation:'Irrigation', irrigation_sub:'Feeds per room per day — solution, volume, feed and runoff EC/pH',
    decon:'Decontamination', decon_sub:'Per-room cleaning cycle, bleach log and swab release gate',
    waste:'Destruction', waste_sub:'Waste manifests, witnessed disposal and batch reconciliation',
    ...
    qc_labs:'QC Laboratories', qc_labs_sub:'Accredited external labs — accreditation, ISO 17025 scope, locale',
    qc_register:'QC Register', qc_register_sub:'Certificate register (QCLB 020 §6.13) — canned queries + numbering-gap check',
    qc_genealogy:'Batch genealogy', qc_genealogy_sub:'Batch lineage variety→cultivation→processing→packaging (m:n blending) + CoQ inheritance',
    ...
    qc_potency:'Potency ladders', qc_potency_sub:'Per-cultivar THC grade ladders (QCSP 001) — approve, supersede, print the A4 spec',
  ...
  mk: {
    ...
    calendar_sub:'Задачи по рок низ месецот', workload_sub:'Оптовареност по личност за неделата — повлечете задача за да ја доделите',
    ...
    rec_every:'Секои N', rec_until:'До (изборно)',
    log_work:'Внеси работа', add_subtask:'Додај под-задача', archive:'Архивирај', outcome:'Резултат', open_detail:'Отвори',
    unarchive:'Врати од архива', archived:'Архивирано', show_archived:'Прикажи архивирани',
    mark_done:'Означи завршено', change_status:'Промени статус',
    inbox:'Сандаче', inbox_sub:'Известувања, тимска активност и преглед',
    ...
    cultivation:'Одгледување', cultivation_sub:'Сорти, кодирани батчови и поединечно нумерирани растенија',
    harvest:'Жетва', harvest_sub:'Лотови од жетва, сув принос и интервалите за заштита што ја условуваат жетвата',
    irrigation:'Наводнување', irrigation_sub:'Хранења по соба по ден — раствор, количина, EC/pH на храна и истек',
    decon:'Деконтаминација', decon_sub:'Циклус на чистење по соба, евиденција за хлор и брисеви',
    waste:'Уништување', waste_sub:'Манифести за отпад, потврдено уништување и усогласување на батчови',
    ...
    qc_labs:'КК Лаборатории', qc_labs_sub:'Акредитирани надворешни лаборатории — акредитација, ISO 17025 опсег, локал',
    qc_register:'КК Регистар', qc_register_sub:'Регистар на сертификати (QCLB 020 §6.13) — предефинирани прашања + проверка на празнини',
    qc_genealogy:'Генеалогија на серии', qc_genealogy_sub:'Лоза на серии сорта→одгледување→преработка→пакување (m:n мешање) + наследување во CoQ',
    ...
    qc_potency:'Скали на јачина', qc_potency_sub:'Скали на THC класи по сорта (QCSP 001) — одобри, замени, печати A4 спецификација',
