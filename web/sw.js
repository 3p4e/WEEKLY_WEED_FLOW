...
const VERSION = 'wwf-shell-v3.92.0';
...
const SHELL = [
  ...
  '/gf/dept-templates.js', '/gf/depthome-view.js', '/gf/notifications-view.js', '/gf/facility-view.js', '/gf/cultivation-view.js', '/gf/harvest-view.js', '/gf/decon-view.js', '/gf/waste-view.js', '/gf/approvals-view.js', '/gf/myday-view.js', '/gf/analytics-view.js', '/gf/auditprep-view.js', '/gf/qmsregistry-view.js', '/gf/qmsknow-view.js', '/gf/qmsstudio-view.js', '/gf/qcspec-view.js', '/gf/qclab-view.js', '/gf/qcregister-view.js', '/gf/qcgenealogy-view.js', '/gf/qcsample-view.js', '/gf/qccoa-view.js', '/gf/qcoos-view.js', '/gf/qcecoa-view.js', '/gf/qccustody-view.js', '/gf/qcleaves-view.js', '/gf/chooser.js', '/gf/tweaks-vanilla.js',
