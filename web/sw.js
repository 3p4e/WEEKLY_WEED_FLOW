...
const VERSION = 'wwf-shell-v2.0.0';

const SHELL = [
  '/',
  '/index.html',
  '/manifest.webmanifest',
  '/gf/app.css', '/gf/brand.css', '/gf/mobile.css', '/gf/views.css', '/gf/leaf-fx.css',
  ...
  '/gf/report-view.js', '/gf/tweaks-vanilla.js',
...
const API_RE = /^\/(auth|departments|weeks|tasks|sessions|ai|audit|reports|health)(\/|$|\?)/;
