...
const VERSION = 'wwf-shell-v3.27.0';
...
const SHELL = [
  ...
  '/gf/dept-templates.js', '/gf/depthome-view.js', '/gf/notifications-view.js', '/gf/facility-view.js', '/gf/approvals-view.js', '/gf/myday-view.js', '/gf/analytics-view.js', '/gf/qmsregistry-view.js', '/gf/qmsknow-view.js', '/gf/qmsstudio-view.js', '/gf/chooser.js', '/gf/tweaks-vanilla.js',
...
const API_RE = /^\/(auth|departments|weeks|tasks|sessions|capture|intake|ai|audit|reports|notifications|activity|facility|approvals|qms|health)(\/|$|\?)/;
