...
- Purely Plant Medical Cannabis Production Facility → "Purely Plant Medical Cannabis Production Facility"
- [COMPANY_NAME] → "Purely Plant GmbH"
- [QP_NAME] → "Blagoj Nikolov"
- Ana Dimitrova → "Ana Dimitrova"
- Stefan Petrov → "Stefan Petrov"
- Marko Georgiev → "Marko Georgiev"
- Skopje → Various facility locations from configuration
...
- Date placeholders 2026-01-22 → Fill with document effective date
...
### Issue: "Purely Plant Medical Cannabis Production Facility not replaced"
