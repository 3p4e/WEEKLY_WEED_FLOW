...
|----------|-------|----------|
| **Personnel** | 37 | `[MANAGER_NAME]`, `[QA_MANAGER_NAME]`, `[PRODUCTION_MANAGER_NAME]` |
| **Other/Generic** | 68 | `[DOCUMENT_NUMBER]`, `[VERSION]`, `[SIGNATURE]` |
| **Equipment** | 12 | `[DRYING_MACHINE_MODEL]`, `[HVAC_SYSTEM]`, `[TRIMMING_MACHINE_MODEL]` |
| **Operational** | 13 | `[OBJECTIVE_1]`, `[RETENTION_PERIOD]`, `[TARGET_METRIC]` |
| **Locations** | 11 | `[ARCHIVE_LOCATION]`, `[STORAGE_LOCATION]`, `[VAULT_LOCATION]` |
| **Facility** | 9 | `[FACILITY_NAME]`, `[FACILITY_ADDRESS]`, `[LEGAL_ENTITY_NAME]` |
| **Dates** | 8 | `[EFFECTIVE_DATE]`, `[EXPIRATION_DATE]`, `[NEXT_REVIEW_DATE]` |
| **Contact** | 3 | `[PHONE]`, `[EMAIL]`, `[PHONE_NUMBER]` |
| **Regulatory** | 2 | `[LICENSE_NUMBER]`, `[REGULATORY_AUTHORITY]` |
